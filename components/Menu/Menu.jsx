...
const Menu = () => {
  ...
  return (
    <nav className="menu z-30!" ref={menuRef}>
      <div className="menu-header" onClick={toggleMenu}>
        <div className="menu-logo">
          <Image alt="logo" src="/logo.webp" height={600} width={600} />
        </div>
      ...
      <div className="menu-overlay" ref={menuOverlayRef}>
          ...
          <div className="menu-overlay-col menu-overlay-col-lg">
            <div className="menu-overlay-sub-col">
              <div className="menu-sub-links">
                <Link href="#manifesto" onClick={handleLinkClick}>
                  Manifesto
                </Link>
            ...
            <div className="menu-overlay-sub-col">
              <div className="menu-sub-links menu-product-links">
                ...
                <Link href="#honor" onClick={handleLinkClick}>
                  Honor & Recognition
                </Link>
                <Link href="#scholar" onClick={handleLinkClick}>
                  Scholar & Statesman
                </Link>
              </div>
            </div>
        ...
        <div className="menu-overlay-footer">
          ...
          <div className="menu-social">
            <a
              href="https://www.facebook.com/profile.php?id=61559863356011"
              target="_blank"
              rel="noopener noreferrer"
              onClick={handleLinkClick}
            >
